...
interface EditTransactionDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (id: string, transaction: Omit<Transaction, 'id' | 'createdAt'>) => void;
  pockets: Pocket[];
  categories: Category[];
  ...
  useEffect(() => {
    if (transaction && isOpen) {
      ...
      const timer = setTimeout(() => {
        ...
        setDisplayAmount(formatRupiah(transaction.amount.toString()));
        setDate(transaction.date);
        setDescription(transaction.description || '');
        setCategoryId(transaction.categoryId || '');
        setPocketId(transaction.pocketId || '');
        setFromPocketId(transaction.fromPocketId || '');
        setToPocketId(transaction.toPocketId || '');
        ...
        {isInitializing ? (
          <>
            ...
            <div className="modal-loading">
              ...
              <div className="modal-loading-text">Loading transaction...</div>
            </div>
          </>
        ) : (
          <>
